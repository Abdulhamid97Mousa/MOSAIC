"""Documentation for MOSAIC MalmoEnv CliffWalking environment."""
from __future__ import annotations


def get_cliffwalking_html(env_id: str) -> str:
    """Generate CliffWalking HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Navigate along cliff edges in Minecraft without falling. Tests precise movement and edge avoidance.</p>
...
MALMOENV_CLIFFWALKING_HTML = get_cliffwalking_html("MalmoEnv-CliffWalking-v0")

__all__ = ["MALMOENV_CLIFFWALKING_HTML", "get_cliffwalking_html"]
