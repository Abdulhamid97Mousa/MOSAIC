"""Documentation for MOSAIC MalmoEnv Vertical environment."""
from __future__ import annotations


def get_vertical_html(env_id: str) -> str:
    """Generate Vertical HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Climb vertically through stacked Minecraft platforms. Requires precise jump timing and vertical spatial reasoning.</p>
...
MALMOENV_VERTICAL_HTML = get_vertical_html("MalmoEnv-Vertical-v0")

__all__ = ["MALMOENV_VERTICAL_HTML", "get_vertical_html"]
