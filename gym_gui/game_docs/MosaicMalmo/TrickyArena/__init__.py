"""Documentation for MOSAIC MalmoEnv TrickyArena environment."""
from __future__ import annotations


def get_trickyarena_html(env_id: str) -> str:
    """Generate TrickyArena HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Survive and navigate a tricky arena in Minecraft. Features hazardous terrain, traps, and obstacles requiring careful movement.</p>
...
MALMOENV_TRICKYARENA_HTML = get_trickyarena_html("MalmoEnv-TrickyArena-v0")

__all__ = ["MALMOENV_TRICKYARENA_HTML", "get_trickyarena_html"]
