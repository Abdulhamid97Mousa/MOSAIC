"""Documentation for MOSAIC MalmoEnv Eating environment."""
from __future__ import annotations


def get_eating_html(env_id: str) -> str:
    """Generate Eating HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Find and consume food items in Minecraft. The agent must locate food sources and use them to survive.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">4</td><td style="border: 1px solid #ddd; padding: 8px;"><code>use 1</code></td><td style="border: 1px solid #ddd; padding: 8px;">Eat/Interact</td></tr>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 6px;"><kbd>E</kbd></td><td style="border: 1px solid #ddd; padding: 6px;">Eat/Use (4)</td></tr>
</table>
...
MALMOENV_EATING_HTML = get_eating_html("MalmoEnv-Eating-v0")

__all__ = ["MALMOENV_EATING_HTML", "get_eating_html"]
