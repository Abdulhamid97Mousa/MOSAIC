"""Documentation for MOSAIC MalmoEnv FindTheGoal environment."""
from __future__ import annotations


def get_findthegoal_html(env_id: str) -> str:
    """Generate FindTheGoal HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Find a specific goal block in the Minecraft world. Pure navigation — no interaction commands, just movement and turning.</p>
...
MALMOENV_FINDTHEGOAL_HTML = get_findthegoal_html("MalmoEnv-FindTheGoal-v0")

__all__ = ["MALMOENV_FINDTHEGOAL_HTML", "get_findthegoal_html"]
