"""Documentation for MOSAIC MalmoEnv MobChase environment."""
from __future__ import annotations


def get_mobchase_html(env_id: str) -> str:
    """Generate MobChase HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Chase and follow a mob through a Minecraft world. The agent must keep the target mob in sight and follow its movement path.</p>
...
MALMOENV_MOBCHASE_HTML = get_mobchase_html("MalmoEnv-MobChase-v0")

__all__ = ["MALMOENV_MOBCHASE_HTML", "get_mobchase_html"]
