"""Documentation for MOSAIC MalmoEnv TreasureHunt environment."""
from __future__ import annotations


def get_treasurehunt_html(env_id: str) -> str:
    """Generate TreasureHunt HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Locate and collect treasure in a Minecraft world. Navigate toward reward items and use them to complete the mission.</p>
...
MALMOENV_TREASUREHUNT_HTML = get_treasurehunt_html("MalmoEnv-TreasureHunt-v0")

__all__ = ["MALMOENV_TREASUREHUNT_HTML", "get_treasurehunt_html"]
