"""Documentation for MOSAIC MalmoEnv CatchTheMob environment."""
from __future__ import annotations


def get_catchthemob_html(env_id: str) -> str:
    """Generate CatchTheMob HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Chase and catch a mob in Minecraft. The agent must track the moving target and use/interact to catch it.</p>
...
MALMOENV_CATCHTHEMOB_HTML = get_catchthemob_html("MalmoEnv-CatchTheMob-v0")

__all__ = ["MALMOENV_CATCHTHEMOB_HTML", "get_catchthemob_html"]
