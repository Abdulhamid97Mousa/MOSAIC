"""Documentation for MOSAIC MalmoEnv DefaultWorld environment."""
from __future__ import annotations


def get_defaultworld_html(env_id: str) -> str:
    """Generate DefaultWorld HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Open sandbox in a default Minecraft world with terrain variation. Explore, fight mobs, and interact with the full world.</p>
...
MALMOENV_DEFAULTWORLD_HTML = get_defaultworld_html("MalmoEnv-DefaultWorld-v0")

__all__ = ["MALMOENV_DEFAULTWORLD_HTML", "get_defaultworld_html"]
