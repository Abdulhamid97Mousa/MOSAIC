"""Documentation for MOSAIC MalmoEnv DefaultFlatWorld environment."""
from __future__ import annotations


def get_defaultflatworld_html(env_id: str) -> str:
    """Generate DefaultFlatWorld HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Open sandbox in a flat Minecraft world. Explore and build using all available commands in a simplified terrain.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">4</td><td style="border: 1px solid #ddd; padding: 8px;"><code>attack 1</code></td><td style="border: 1px solid #ddd; padding: 8px;">Attack/Break</td></tr>
...
MALMOENV_DEFAULTFLATWORLD_HTML = get_defaultflatworld_html("MalmoEnv-DefaultFlatWorld-v0")

__all__ = ["MALMOENV_DEFAULTFLATWORLD_HTML", "get_defaultflatworld_html"]
