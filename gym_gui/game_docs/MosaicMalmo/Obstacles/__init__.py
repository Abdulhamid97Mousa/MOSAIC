"""Documentation for MOSAIC MalmoEnv Obstacles environment."""
from __future__ import annotations


def get_obstacles_html(env_id: str) -> str:
    """Generate Obstacles HTML documentation."""
    return f"""
<h2>{env_id}</h2>
...
<p>Navigate an obstacle course in Minecraft. Jump, climb, and maneuver through challenging terrain to reach the goal.</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">4</td><td style="border: 1px solid #ddd; padding: 8px;"><code>use 1</code></td><td style="border: 1px solid #ddd; padding: 8px;">Use/Jump Activate</td></tr>
...
MALMOENV_OBSTACLES_HTML = get_obstacles_html("MalmoEnv-Obstacles-v0")

__all__ = ["MALMOENV_OBSTACLES_HTML", "get_obstacles_html"]
