"""CLI entrypoint for TorchRL worker."""
...
def main() -> int:
    """Main entry point for the TorchRL worker CLI."""
    parser = argparse.ArgumentParser(description="TorchRL Worker CLI")
    parser.add_argument(
        "--config",
        type=Path,
        required=True,
    ...
    try:
        ...
        runtime = TorchRLWorkerRuntime(work_dir=args.work_dir)
