"""MOSAIC TorchRL site customizations.

Patches gymnasium.make so that TorchRL's GymEnv (which calls gym.make
...
try:
    ...
    from torchrl_worker.fastlane import is_fastlane_enabled, maybe_wrap_env  # type: ignore
