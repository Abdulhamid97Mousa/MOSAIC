"""MOSAIC Tianshou site customizations.

Patches gymnasium.make so that Tianshou's environment creation automatically
gets FastLane frame streaming when enabled.
"""
...
try:
    ...
    from tianshou_worker.fastlane import is_fastlane_enabled, maybe_wrap_env  # type: ignore
