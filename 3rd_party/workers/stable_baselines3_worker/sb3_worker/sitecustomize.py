"""MOSAIC SB3 site customizations.

Patches gymnasium.make so that stable-baselines3's make_vec_env (which calls
gym.make internally) automatically gets FastLane frame streaming when enabled.
"""
...
try:
    ...
    from sb3_worker.fastlane import is_fastlane_enabled, maybe_wrap_env  # type: ignore
