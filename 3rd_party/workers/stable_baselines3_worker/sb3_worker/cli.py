...
def main() -> int:
    """Main entry point for the SB3 worker CLI."""
    parser = argparse.ArgumentParser(description="Stable-Baselines3 Worker CLI")
    parser.add_argument(
        "--config",
        type=Path,
        required=True,
    ...
    try:
        ...
        runtime = SB3WorkerRuntime(work_dir=args.work_dir)
