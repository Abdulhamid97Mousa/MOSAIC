...
Usage (smoke -- ~5 min):
  ...
  python -m jaxmarl_worker.algorithms.ippo_scan_socialjax \\
    --run-dir var/trainer/coop_mining/IPPO --total-updates 50 --n-envs 8

Usage (full -- ~300M steps):
  XLA_PYTHON_CLIENT_PREALLOCATE=false \\
  python -m jaxmarl_worker.algorithms.ippo_scan_socialjax \\
    --run-dir var/trainer/coop_mining/IPPO --total-updates 1562 --n-envs 32
"""
import os
...
from jaxmarl_worker.algorithms.ippo_scan import make_train
