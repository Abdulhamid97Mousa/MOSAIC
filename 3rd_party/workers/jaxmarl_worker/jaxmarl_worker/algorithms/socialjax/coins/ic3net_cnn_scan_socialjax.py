"""IC3Net-CNN for SocialJax coin_game.
...
Run:
  CUDA_VISIBLE_DEVICES=1 XLA_PYTHON_CLIENT_PREALLOCATE=false \\
    python -m jaxmarl_worker.algorithms.socialjax.coins.ic3net_cnn_scan_socialjax
"""
...
def parse_args():
    _default_out = str(
        ...
        / "var" / "trainer" / "socialjax" / "coins" / "IC3Net_CNN"
    )
...
def main():
    ...
    print(f"[IC3Net-CNN] coin_game  n_agents={args.num_agents}  "
