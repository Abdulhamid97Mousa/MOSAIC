"""CommNet-CNN for SocialJax clean_up.
...
Run:
  CUDA_VISIBLE_DEVICES=0 XLA_PYTHON_CLIENT_PREALLOCATE=false \\
    python -m jaxmarl_worker.algorithms.socialjax.cleanup.commnet_cnn_scan_socialjax
"""
...
def parse_args():
    _default_out = str(
        ...
        / "var" / "trainer" / "socialjax" / "cleanup" / "CommNet_CNN"
    )
...
def main():
    ...
    print(f"[CommNet-CNN] clean_up  n_agents={args.num_agents}  "
