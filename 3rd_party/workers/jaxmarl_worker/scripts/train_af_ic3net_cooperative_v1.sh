#!/bin/bash
# AF IC3Net COOPERATIVE — V1 campaign
# Variants: G-2v0, B-0v2 — needed for ghost-inertness table.
# Usage: GPU=0 bash .../train_af_ic3net_cooperative_v1.sh

set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../.." && pwd)"
PYTHON="$PROJECT_ROOT/.venv/bin/python"
RUNS_ROOT="$PROJECT_ROOT/var/trainer/multigrid_sports/AF_m256_20k/IC3Net/VIEWSIZE7/cooperative/V1"
GPU="${GPU:-0}"
...
echo "========================================================"
echo "  AF IC3Net COOPERATIVE V1  (G-2v0, B-0v2)"
...
for VARIANT in $VARIANTS; do
    ...
    LOG="$PROJECT_ROOT/var/logs/af-ic3net-cooperative-v1-$VARIANT.log"
