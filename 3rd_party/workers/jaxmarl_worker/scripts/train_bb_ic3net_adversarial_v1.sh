#!/bin/bash
# BB IC3Net ADVERSARIAL — V1 campaign
...
#
# Path: var/trainer/multigrid_sports/BB_m256_20k/IC3Net/VIEWSIZE7/adversarial/V1/<VARIANT>/checkpoints/bb-<variant>/final.npz
#
# Usage: GPU=0 bash 3rd_party/workers/jaxmarl_worker/scripts/train_bb_ic3net_adversarial_v1.sh
...
RUNS_ROOT="$PROJECT_ROOT/var/trainer/multigrid_sports/BB_m256_20k/IC3Net/VIEWSIZE7/adversarial/V1"
GPU="${GPU:-0}"
...
echo "========================================================"
echo "  BB IC3Net ADVERSARIAL V1 (gated comm)"
...
for VARIANT in $VARIANTS; do
    ...
    LOG="$PROJECT_ROOT/var/logs/bb-ic3net-adversarial-v1-$VARIANT.log"
