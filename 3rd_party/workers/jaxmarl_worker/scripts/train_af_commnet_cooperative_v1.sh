#!/bin/bash
# AF CommNet COOPERATIVE — V1 campaign
# Variants: G-2v0 (green 2v0), B-0v2 (blue 0v2) — needed for ghost-inertness table.
# Usage: GPU=0 bash .../train_af_commnet_cooperative_v1.sh

set -euo pipefail
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/../../../.." && pwd)"
PYTHON="$PROJECT_ROOT/.venv/bin/python"
RUNS_ROOT="$PROJECT_ROOT/var/trainer/multigrid_sports/AF_m256_20k/CommNet/VIEWSIZE7/cooperative/V1"
GPU="${GPU:-0}"
...
echo "========================================================"
echo "  AF CommNet COOPERATIVE V1  (G-2v0, B-0v2)"
...
for VARIANT in $VARIANTS; do
    ...
    LOG="$PROJECT_ROOT/var/logs/af-commnet-cooperative-v1-$VARIANT.log"
