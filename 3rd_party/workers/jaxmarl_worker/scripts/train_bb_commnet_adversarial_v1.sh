#!/bin/bash
# BB CommNet ADVERSARIAL — V1 campaign
# CommNet: shared GRU encoder + mean-pool communication (Sukhbaatar et al. NeurIPS 2016)
#
# Path: var/trainer/multigrid_sports/BB_m256_20k/CommNet/VIEWSIZE7/adversarial/V1/<VARIANT>/checkpoints/bb-<variant>/final.npz
#
# Usage: GPU=0 bash 3rd_party/workers/jaxmarl_worker/scripts/train_bb_commnet_adversarial_v1.sh
...
RUNS_ROOT="$PROJECT_ROOT/var/trainer/multigrid_sports/BB_m256_20k/CommNet/VIEWSIZE7/adversarial/V1"
GPU="${GPU:-0}"
...
echo "========================================================"
echo "  BB CommNet ADVERSARIAL V1 (mean-pool comm)"
...
for VARIANT in $VARIANTS; do
    ...
    LOG="$PROJECT_ROOT/var/logs/bb-commnet-adversarial-v1-$VARIANT.log"
