"""CLI entrypoint for MushroomRL worker."""
...
def main() -> int:
    """Main entry point for the MushroomRL worker CLI."""
    parser = argparse.ArgumentParser(description="MushroomRL Worker CLI")
    parser.add_argument(
        "--config",
        type=Path,
        required=True,
    ...
    try:
        ...
        runtime = MushroomRLWorkerRuntime(work_dir=args.work_dir)
