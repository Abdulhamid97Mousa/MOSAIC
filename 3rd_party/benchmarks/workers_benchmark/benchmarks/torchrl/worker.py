"""torchrl worker benchmark -- PPO through torchrl_worker.launcher.

Calls the launcher module directly (same pattern as TianshouWorkerRuntime),
...
def run_worker_benchmark(config) -> BenchmarkResult:
    """Run torchrl PPO via the worker launcher subprocess."""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        config_dict = {
            "run_id": f"bench_torchrl_worker_{config.seed}",
            "algo": "ppo",
        ...
        cmd = [
            sys.executable, "-m", "torchrl_worker.launcher",
