"""torchrl fastlane benchmark -- worker launcher + SHM frame streaming."""
...
def run_fastlane_benchmark(config) -> BenchmarkResult:
    """Run torchrl PPO via worker launcher with FastLane enabled."""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        config_dict = {
            "run_id": f"bench_torchrl_fl_{config.seed}",
            "algo": "ppo",
