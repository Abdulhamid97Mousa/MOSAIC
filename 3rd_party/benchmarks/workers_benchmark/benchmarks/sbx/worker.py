"""sbx worker benchmark -- PPO through sbx_worker.launcher.
...
def run_worker_benchmark(config) -> BenchmarkResult:
    """Run sbx PPO via the worker launcher subprocess."""
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        config_dict = {
            "run_id": f"bench_sbx_worker_{config.seed}",
            "algo": "ppo",
        ...
        cmd = [
            sys.executable, "-m", "sbx_worker.launcher",
